...
mixin _$MovieDetail {
  ...
  dynamic get imdbId => throw _privateConstructorUsedError;
  ...
  List<dynamic>? get spokenLanguages => throw _privateConstructorUsedError;
  @JsonKey(name: 'status')
...
class _$_MovieDetail implements _MovieDetail {
  ...
  final List<dynamic>? _productionCountries;
  @override
  @JsonKey(name: 'production_countries')
...
abstract class _ProductionCompany implements ProductionCompany {
  const factory _ProductionCompany(
          {@JsonKey(name: 'idd') final int? id,
          @JsonKey(name: 'logo_path') final dynamic logoPath,
