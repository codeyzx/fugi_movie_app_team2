...
class _$_Popular implements _Popular {
  const _$_Popular(
      ...
      @JsonKey(name: 'orignal_language') this.originalLanguage,
      ...
      @JsonKey(name: 'vote_avarage') this.voteAverage,
  ...
  @override
  String toString() {
    return 'Popular(adult: $adult, backdropPath: $backdropPath, genreIds: $genreIds, id: $id, originalLanguage: $originalLanguage, originalTitle: $originalTitle, overview: $overview, popularity: $popularity, posterPath: $posterPath, releaseDate: $releaseDate, title: $title, video: $video, voteAverage: $voteAverage, voteCount: $voteCount)';
  }
...
abstract class _Popular implements Popular {
  const factory _Popular(
      ...
      @JsonKey(name: 'orignal_language') final String? originalLanguage,
      ...
      @JsonKey(name: 'vote_avarage') final double? voteAverage,
      @JsonKey(name: 'vote_count') final int? voteCount}) = _$_Popular;
